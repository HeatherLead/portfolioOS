  ...
  return (
    <div className="w-screen h-screen p-0 m-0 overflow-hidden  flex justify-center items-center">
      ...
      >
        ...
        <div className="grid grid-cols-8 grid-rows-10 gap-5 w-full h-[90%] p-5 pt-0 overflow-hidden">
          <div className=" col-span-3 row-span-6 border rounded p-3">
            <h1
              className={`text-lg font-semibold mb-2  ${space_mono.className}`}
            >
              My Timeline
            </h1>
            <Timeline />
          ...
          <div className=" col-span-3 row-span-2 border rounded p-2">
            ...
            <p className=" text-sm overflow-clip">
              Experienced web development enthusiast with 2 years of experience
              in building websites and web applications.
            </p>
          </div>
          <div className=" col-span-2 row-span-4 border rounded p-2 ">
            <h1 className={`mb-2 ${space_mono.className}`}>Contacts</h1>
          ...
          <div className=" col-span-2 row-span-3 border rounded p-2">
            <p className={`font-bold pb-2  ${space_mono.className}`}>
